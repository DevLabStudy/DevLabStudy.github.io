...
Do infrastruktury dołączył **Dell OptiPlex 790 SFF**. To świetna, budżetowa maszyna, która idealnie wpasowała się jako kolejny węzeł pod wirtualizację w Proxmoxie. Żeby dodać mu trochę skrzydeł, szczególnie pod kątem akceleracji sprzętowej.
### Co w planach?
